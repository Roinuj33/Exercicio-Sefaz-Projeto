...
public class PessoaBean {
	...
	public void salvar() throws IOException {
		...
		if (this.pessoaDAO.inserir(this.pessoa)) {
			...
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "", "Erro inserido!"));
		}
	...
	private boolean existeLivro(Livro livro) {
		...
		for (Livro livroLista : this.pessoa.getLivros()) {
			if (livroLista.getNome() == livro.getNome() && livroLista.getAutor().equals(livro.getAutor())) {
				retorno = true;
			}
		}
	...
	public String getCpfSelecioanado() {
